...
public class FriendlistAdapter extends BaseAdapter{
	...
	private List<AddfriendMessage> messages;
	private Object[][] ids;
	private boolean multiple = true;
	public FriendlistAdapter(Context contexts,List<AddfriendMessage> messages) {
		 super();
	...
	public FriendlistAdapter(Context contexts,List<AddfriendMessage> messages, boolean multiple) {
		 super();
		 this.context = contexts;
		 this.messages =messages;
		 this.ids=new Object[messages.size()][3];
