...
public class DayMain extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.d_daymain);
	...
	private void initView()
	{
		...
		atme=(Button)findViewById(R.id.btnatme);
		 ...
		 atme.setOnClickListener(new OnClickListener()
		 {
			...
			public void onClick(View arg0) {
				...
				Intent intent=new Intent(DayMain.this,AtMeActivity.class);
		...
		btnadd.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				Intent it=new Intent(DayMain.this,DayAdd.class);
				startActivity(it);
		...
		DayDay hm = new DayDay();
		DayDiy hs = new DayDiy();
		mFragments.add(hm);
		mFragments.add(hs);
